 ...
 */
  ...
  49: [function (_dereq_, module, exports) {
    ...
    ;(function (window) {
      // Convenience aliases.
      var getClass = {}.toString; var isProperty; var forEach; var undef
      ...
      function has (name) {
        ...
        if (name == 'bug-string-char-index') {
          ...
          if (name == 'json-stringify') {
            var stringify = JSON3.stringify; var stringifySupported = typeof stringify === 'function' && isExtended
      ...
      if (!has('json')) {
        ...
        if (!has('json-stringify')) {
          ...
          var quote = function (value) {
            var result = '"'; var index = 0; var length = value.length; var isLarge = length > 10 && charIndexBuggy; var symbols
            if (isLarge) {
              symbols = value.split('')
            }
